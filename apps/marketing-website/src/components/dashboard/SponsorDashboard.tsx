...
import { Eye, MousePointerClick, TrendingDown, Sparkles } from "lucide-react";
    ...
    return (
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                <MetricCard title="Total Impressions" value="45.2k" trend="+12%" icon={Eye} color="blue" />
                <MetricCard title="Clicks" value="1,204" trend="+5%" icon={MousePointerClick} color="green" />
                <MetricCard title="Conversion Rate" value="2.6%" trend="-0.4%" icon={TrendingDown} color="yellow" />
                <MetricCard title="Active Campaigns" value="3" trend="Stable" icon={Sparkles} color="blue" />
            </div>
