...
export function MissionCharterModal({ isOpen, onClose }: MissionCharterModalProps) {
    return (
        <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
            <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto bg-[#F4F4F0] p-0 rounded-xl">
                <DialogHeader className="sr-only">
                    <DialogTitle>Mission Charter</DialogTitle>
                    <DialogDescription>Our mission and public benefit commitments</DialogDescription>
                </DialogHeader>
