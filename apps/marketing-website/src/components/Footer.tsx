            ...
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6 text-sm">
                ...
                <div className="flex flex-col items-center md:items-end gap-4">
                    ...
                    <div className="flex gap-6 text-black/60 font-sans">
                        ...
                        <Link href="/partner-portal" className="hover:text-black transition-colors">Partner Login</Link>
                        <Link href="/employee-portal" className="hover:text-black transition-colors">Employee Login</Link>
                    </div>
